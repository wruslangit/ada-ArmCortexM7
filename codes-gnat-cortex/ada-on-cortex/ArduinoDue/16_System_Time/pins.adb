...
package body Pins is
   ...
   begin
      case Pin is
         when Pin_2 =>
            ...
            Registers.ISER0 := Registers.Bit_12;
         ...
         when Pin_3 =>
            ...
            Registers.ISER0 := Registers.Bit_13;
         ...
         when Pin_11 =>
            ...
            Registers.ISER0 := Registers.Bit_14;
   ...
   begin
      case Pin is
         when Pin_2 =>
            Registers.PIOB_IER := Registers.Bit_25;

         when Pin_3 =>
            Registers.PIOC_IER := Registers.Bit_28;

         when Pin_4 =>
            Registers.PIOC_IER := Registers.Bit_26;

         when Pin_5 =>
            Registers.PIOC_IER := Registers.Bit_25;

         when Pin_6 =>
            Registers.PIOC_IER := Registers.Bit_24;

         when Pin_7 =>
            Registers.PIOC_IER := Registers.Bit_23;

         when Pin_8 =>
            Registers.PIOC_IER := Registers.Bit_22;

         when Pin_9 =>
            Registers.PIOC_IER := Registers.Bit_21;

         when Pin_10 =>
            Registers.PIOC_IER := Registers.Bit_29;

         when Pin_11 =>
            Registers.PIOD_IER := Registers.Bit_7;

         when Pin_12 =>
            Registers.PIOD_IER := Registers.Bit_8;

         when Pin_13 =>
            Registers.PIOB_IER := Registers.Bit_27;
      end case;
   ...
   begin
      case Pin is
         when Pin_2 =>
            Registers.PIOB_IDR := Registers.Bit_25;

         when Pin_3 =>
            Registers.PIOC_IDR := Registers.Bit_28;

         when Pin_4 =>
            Registers.PIOC_IDR := Registers.Bit_26;

         when Pin_5 =>
            Registers.PIOC_IDR := Registers.Bit_25;

         when Pin_6 =>
            Registers.PIOC_IDR := Registers.Bit_24;

         when Pin_7 =>
            Registers.PIOC_IDR := Registers.Bit_23;

         when Pin_8 =>
            Registers.PIOC_IDR := Registers.Bit_22;

         when Pin_9 =>
            Registers.PIOC_IDR := Registers.Bit_21;

         when Pin_10 =>
            Registers.PIOC_IDR := Registers.Bit_29;

         when Pin_11 =>
            Registers.PIOD_IDR := Registers.Bit_7;

         when Pin_12 =>
            Registers.PIOD_IDR := Registers.Bit_8;

         when Pin_13 =>
            Registers.PIOB_IDR := Registers.Bit_27;
      end case;
   ...
   begin
      case Pin is
         when Pin_2 | Pin_13 =>
            Dummy := Registers.PIOB_ISR;

         when Pin_3 .. Pin_10 =>
            Dummy := Registers.PIOC_ISR;

         when Pin_11 | Pin_12 =>
            Dummy := Registers.PIOD_ISR;
      end case;            
   end Clear_Interrupt;
