package Registers is
   ...
   PIOB_IER : Word;
   pragma Volatile (PIOB_IER);
   pragma Import (C, PIOB_IER, "PIOB_IER");

   PIOB_IDR : Word;
   pragma Volatile (PIOB_IDR);
   pragma Import (C, PIOB_IDR, "PIOB_IDR");

   PIOB_ISR : Word;
   pragma Volatile (PIOB_ISR);
   pragma Import (C, PIOB_ISR, "PIOB_ISR");
   ...
   PIOD_IER : Word;
   pragma Volatile (PIOD_IER);
   pragma Import (C, PIOD_IER, "PIOD_IER");

   PIOD_IDR : Word;
   pragma Volatile (PIOD_IDR);
   pragma Import (C, PIOD_IDR, "PIOD_IDR");

   PIOD_ISR : Word;
   pragma Volatile (PIOD_ISR);
   pragma Import (C, PIOD_ISR, "PIOD_ISR");
